...
- **按南邮格式写/改论文**:宋体黑体混排、行距、章节层级、页眉页码、图题表题,自动符合规范
  *Write/edit your thesis to NJUPT formatting: mixed SimSun/SimHei fonts, line spacing, heading levels, headers & page numbers, figure/table captions — all compliant by default.*
